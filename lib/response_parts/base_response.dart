...
class BaseResponse<T> {
  ...
  static fromApi<T>(Map<String, dynamic> data, T Function(Map<String, dynamic> json) fromJsonT) {
    return BaseResponse(BodyResponsePart.fromJson(data['Body'], (data) => fromJsonT(data as Map<String, dynamic>)),
        HeaderResponsePart.fromJson(data['Header']), ErrorResponsePart.fromJson(data['Error']));
  }
}
